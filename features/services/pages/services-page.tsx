					...
					<div className="flex flex-col gap-12">
						<div className="mx-auto flex max-w-[768px] flex-col items-center text-center">
							<span className="rounded-xl bg-[#D8E2FF] px-4 py-1.5 text-xs font-semibold uppercase tracking-[0.6px] text-[#001A42]">
								...
								Cung cấp giải pháp cho thuê xe du lịch, xe cưới, sự kiện doanh
								nghiệp với đa dạng dòng xe từ 9 chỗ đến 45 chỗ. Tài xế giàu kinh
								nghiệm, am hiểu địa hình và phục vụ tận tâm.
							</p>
						</div>
							...
							{rentalServices.map((item) => (
								<article
									...
									<div className="flex flex-col gap-3 p-6">
										...
										<p className="text-sm leading-[1.6] text-[#424654]">
											{item.description}
										</p>
										<Link
											href="/contact"
